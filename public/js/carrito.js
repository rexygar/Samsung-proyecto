...
var Bancos = {
    ...
    "BancosCL": [{
            "NombreBancos": "BANCO DE CHILE"

        },

        {
            "NombreBancos": "BANCO INTERNACIONAL"

        },

        {
            "NombreBancos": "SCOTIABANK CHILE"

        },

        {
            "NombreBancos": "BANCO DE CREDITO E INVERSIONES"

        },

        {
            "NombreBancos": "CORPBANCA"

        },

        {
            "NombreBancos": "BANCO BICE"

        },

        {
            "NombreBancos": "HSBC BANK (CHILE)"

        },

        {
            "NombreBancos": "BANCO SANTANDER-CHILE"

        },

        {
            "NombreBancos": "BANCO ITAÚ CHILE"

        },

        {
            "NombreBancos": "BANCO SECURITY"

        },

        {
            "NombreBancos": "BANCO FALABELLA"

        },

        {
            "NombreBancos": "DEUTSCHE BANK (CHILE)"

        },

        {
            "NombreBancos": "BANCO RIPLEY"

        },

        {
            "NombreBancos": "RABOBANK CHILE"

        },

        {
            "NombreBancos": "BANCO CONSORCIO"

        },

        {
            "NombreBancos": "BANCO PENTA"

        },

        {
            "NombreBancos": "BANCO PARIS"

        },

        {
            "NombreBancos": "BANCO BILBAO VIZCAYA ARGENTARIA, CHILE (BBVA)"

        },
        {
            "NombreBancos": "BANCO DEL ESTADO DE CHILE"
...
jQuery(document).ready(function() {
    ...
    var htmlBancos = '<option value="sin-region">Seleccione comuna</option>';
