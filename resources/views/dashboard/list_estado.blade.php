              ...
              <input type="hidden" id="rutaListar" value="{{ route('list.estado') }}">
                <div class="col-span-12">
                  ...
                  <div class="flex justify-between items-center bg-gray-100 border-b px-6 py-4">
                    <p class="text-5xl text-gray-800 font-semibold">Lista de Estado de Compras</p>
                  </div>
                  <!-- End Header -->
                  ...
                  <table class="overflow-x-auto w-full bg-white divide-y divide-gray-200 data-table">
                    <thead class="bg-gray-50 text-gray-800 text-sm">
                      <tr class="divide-x divide-gray-300">
                        ...
                        <th class="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase">Orden de Transporte</th>
