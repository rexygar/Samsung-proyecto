                        ...
                        <div class="flex flex-col">
                            ...
                            <select id="regiones">
                                @if (isset($precio->region))
                                    <option value="{{ $precio->region }}" selected disabled>{{ $precio->region }}</option>
                                @endif
                            </select>
                            <br>
                            <select id="comunas">
                                @if (isset($precio->comuna))
                                    <option value="{{ $precio->comuna }}" selected disabled>{{ $precio->comuna }}</option>
                                @endif
                            </select>
                            <br>
                            ...
                            <div class="pt-4 flex items-center space-x-4">
                              <button id="crear" type="submit" class="bg-blue-500 flex justify-center items-center w-full text-white px-4 py-3 rounded-md focus:outline-none">Generar</button>
                              <a href="#" class="bg-red-700 flex justify-center items-center w-full text-white px-4 py-3 rounded-md focus:outline-none">Cancelar</a>
                            </div>
                        </div>
                      </div>
                    </div>
