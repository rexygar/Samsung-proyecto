    ...
    <nav
        ...
        <div class="grid grid-cols-12 md:grip-cols-10 lg:py-2 ">
            <div class="md:col-span-2 col-span-2 xl:col-span-2 2xl:col-span-2  lg:col-span-2  ">
                <a class="navbar-brand lg:w-1/3 lg:mx-auto md:w-5/6" href="http://localhost:8000">
                    <img class="branding__logo img-fluid" src="http://localhost:8000/img/logo.png" max-width="95px"
                        alt="">
                </a>
            </div>
            <div
            ...
            <div
                class="md:col-span-4 lg:col-span-4  sm:col-span-6 col-span-3 col-start-9 sm:col-start-5 xl:col-span-3 2xl:col-span-3  md:col-start-9  2xl:col-start-9 xl:col-start-9  lg:col-start-9  grid grid-cols-2 md:-ml-16">
                <div class="col-span-2">
                    ...
                    {{-- <div class="md:col-span-2 lg:col-span-2 inline-block relative sm:col-span-2  xl:col-span-2">
                        ...
                        <a href="http://localhost:8000/Carrito"
