    ...
    <div class="mt-8 overflow-hidden  sm:rounded-lg">
      <div class="grid grid-cols-5  gap-4">
        ...
        <div class="mb-10 md:container md:mx-auto">
          ...
          <h5 class="font-bold  text-base text-center ">Tecnobuy</h5>
          <p class="text-sm font-bold text-center blue-clr ">$000.000</p>
          <a href="" class="blue-clr-bg font-bold lowercase md:flex md:justify-center md:mx-6 lg:mx-10 text-white">Comprar</a>
        ...
        <div class="mb-10 md:container md:mx-auto">
          ...
          <h5 class="font-bold  text-base text-center ">Tecnobuy</h5>
          <p class="text-sm font-bold text-center blue-clr ">$000.000</p>
          <a href="" class="blue-clr-bg font-bold lowercase md:flex md:justify-center md:mx-6 lg:mx-10 pm-2 text-white">Comprar</a>
