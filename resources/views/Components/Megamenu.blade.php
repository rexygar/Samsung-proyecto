            ...
            <ul class="px-4 w-full   pb-6 pt-6 lg:pt-3">
              <li class="submenu grid grid-cols-5">
                <a href="{{ url('Categoria/SMARTPHONES') }}"
                  class="block-inline p-3 hover:bg-black opacity-30 text-black hover:text-white tracking-wide"
                ...
                <ul class="col-span-2 px-4 w-full  -mb-60 pb-6 pt-6 lg:pt-3">
                  <li class="subsub grid grid-cols-2">
                    <a href="{{ url('Categoria/TELEFONOS/SMARTPHONES/FLAGSHIP') }}"
                      class="block p-3 hover:bg-black opacity-30 text-black hover:text-white tracking-wide">FLAGSHIP</a>
                    <ul class="px-4 w-full   pb-6 pt-6 lg:pt-3">
                      <li>
                        <a href="{{ url('Categoria/TELEFONOS/SMARTPHONES/FLAGSHIP/GALAXY Z') }}"
                          class="block p-3 hover:bg-black opacity-30 text-black hover:text-white tracking-wide">Galaxy
                          Z</a>
                      </li>
                      <li>
                  ...
                  <li class="subsub grid grid-cols-2">
                    <a href="{{ url('Categoria/TELEFONOS/SMARTPHONES/NORMAL') }}"
                      class="block p-3 hover:bg-black opacity-30 text-black hover:text-white tracking-wide">NORMAL</a>
                    <ul class="px-4 w-full   pb-6 pt-6 lg:pt-3">
                      <li>
            ...
            <ul class="px-4 w-full   pb-6 pt-6 lg:pt-3">
              <li class="submenu grid grid-cols-5">
                <a href="{{ url('Categoria/TABLETS/TAB') }}"
                  class="block-inline p-3 hover:bg-black opacity-30 text-black hover:text-white tracking-wide">TAB</a>
                <ul class="px-4 w-full   pb-6 pt-6 lg:pt-3">
                  <li>
            ...
            <ul class="px-4 w-full   pb-6 pt-6 lg:pt-3">
                ...
                <ul class="px-4 w-full   pb-6 pt-6 lg:pt-3">
                  <li>
                    <a href="{{ url('Categoria/WEARABLES/EARABLES/BUD') }}"
                      class="block p-3 hover:bg-black opacity-30 text-black hover:text-white tracking-wide">BUD</a>
                  </li>
                </ul>
              ...
              <li class="submenu grid grid-cols-5">
                <a href="{{ url('Categoria/WEARABLES/SMARTWATCH') }}"
                  class="block-inline p-3 hover:bg-black opacity-30 text-black hover:text-white tracking-wide">SMARTWATCH</a>
                <ul class="px-4 w-full   pb-6 pt-6 lg:pt-3">
                  <li>
                    <a href="{{ url('Categoria/WEARABLES/SMARTWATCH/Watch') }}"
                      class="block p-3 hover:bg-black opacity-30 text-black hover:text-white tracking-wide">Watch</a>
                  </li>
                </ul>
              </li>
              <li class="submenu grid grid-cols-5">
                <a href="{{ url('Categoria/WEARABLES/SPORTBAND') }}"
                  class="block-inline p-3 hover:bg-black opacity-30 text-black hover:text-white tracking-wide">SPORTBAND</a>
                <ul class="px-4 w-full   pb-6 pt-6 lg:pt-3">
                  <li>
                    <a href="{{ url('Categoria/WEARABLES/SPORTBAND/Fit') }}"
                      class="block p-3 hover:bg-black opacity-30 text-black hover:text-white tracking-wide">Fit</a>
                  </li>
                </ul>
              </li>
              <li class="submenu grid grid-cols-5">
            ...
            <ul class="px-4 w-full   pb-6 pt-6 lg:pt-3">
              <li class="submenu grid grid-cols-5">
                <a href="{{ url('Categoria/ACCESORIOS/AUDIFONOS') }}"
                  class="block-inline p-3 hover:bg-black opacity-30 text-black hover:text-white tracking-wide">AUDIFONOS
                </a>
                <ul class="px-4 w-full   pb-6 pt-6 lg:pt-3">
                  <li>
                    <a href="{{ url('Categoria/ACCESORIOS/AUDIFONOS/On ear') }}"
                      class="block p-3 hover:bg-black opacity-30 text-black hover:text-white tracking-wide">On
                      ear</a>
                  </li>
                  <li>
                    <a href="{{ url('Categoria/ACCESORIOS/AUDIFONOS/In ear') }}"
                      class="block p-3 hover:bg-black opacity-30 text-black hover:text-white tracking-wide">in
                      ear</a>
                  </li>
                </ul>
              ...
              <li class="submenu grid grid-cols-5">
                <a href="{{ url('Categoria/ACCESORIOS/PARLANTES') }}"
                  class="block-inline p-3 hover:bg-black opacity-30 text-black hover:text-white tracking-wide">PARLANTES</a>
                <ul class="px-4 w-full   pb-6 pt-6 lg:pt-3">
                  <li>
                    <a href="{{ url('Categoria/ACCESORIOS/PARLANTES/Mini') }}"
                      class="block p-3 hover:bg-black opacity-30 text-black hover:text-white tracking-wide">Mini</a>
                  </li>
                  <li>
                    <a href="{{ url('Categoria/ACCESORIOS/PARLANTES/Bar') }}"
                      class="block p-3 hover:bg-black opacity-30 text-black hover:text-white tracking-wide">Bar</a>
                  </li>
                  <li>
                    <a href="{{ url('Categoria/ACCESORIOS/PARLANTES/Outdoor') }}"
                      class="block p-3 hover:bg-black opacity-30 text-black hover:text-white tracking-wide">Outdoor</a>
                  </li>
                </ul>
              </li>
              <li class="submenu grid grid-cols-5">
                <a href="{{ url('Categoria/ACCESORIOS/CABLES') }}"
                  class="block-inline p-3 hover:bg-black opacity-30 text-black hover:text-white tracking-wide">CABLES</a>
                <ul class="px-4 w-full   pb-6 pt-6 lg:pt-3">
                  <li>
                    <a href="{{ url('Categoria/ACCESORIOS/CABLES/Tipo C') }}"
                      class="block p-3 hover:bg-black opacity-30 text-black hover:text-white tracking-wide">Tipo
                      C</a>
                  </li>
                  <li>
                    <a href="{{ url('Categoria/ACCESORIOS/CABLES/3IN1') }}"
                      class="block p-3 hover:bg-black opacity-30 text-black hover:text-white tracking-wide">3IN1</a>
                  </li>
                  <li>
                    <a href="{{ url('Categoria/ACCESORIOS/CABLES/2IN1') }}"
                      class="block p-3 hover:bg-black opacity-30 text-black hover:text-white tracking-wide">2IN1</a>
                  </li>
                  <li>
                    <a href="{{ url('Categoria/ACCESORIOS/CABLES/HUB') }}"
                      class="block p-3 hover:bg-black opacity-30 text-black hover:text-white tracking-wide">HUB</a>
                  </li>
                </ul>
              </li>
              <li class="submenu grid grid-cols-5">
                <a href="{{ url('Categoria/ACCESORIOS/CASES') }}"
                  class="block-inline p-3 hover:bg-black opacity-30 text-black hover:text-white tracking-wide">CASES</a>
                <ul class="px-4 w-full   pb-6 pt-6 lg:pt-3">
                  <li>
                    <a href="{{ url('Categoria/ACCESORIOS/CASES/NOTE 20') }}"
                      class="block p-3 hover:bg-black opacity-30 text-black hover:text-white tracking-wide">NOTE
                      20</a>
                  </li>
                  <li>
                    <a href="{{ url('Categoria/ACCESORIOS/CASES/S20') }}"
                      class="block p-3 hover:bg-black opacity-30 text-black hover:text-white tracking-wide">S20</a>
                  </li>
                  <li>
                    <a href="{{ url('Categoria/ACCESORIOS/CASES/TAB') }}"
                      class="block p-3 hover:bg-black opacity-30 text-black hover:text-white tracking-wide">TAB</a>
                  </li>
                </ul>
              </li>
              <li class="submenu grid grid-cols-5">
                <a href="{{ url('Categoria/CHARGER') }}"
                  class="block-inline p-3 hover:bg-black opacity-30 text-black hover:text-white tracking-wide">CHARGER</a>
                <ul class="px-4 w-full   pb-6 pt-6 lg:pt-3">
                  <li>
                    <a href="{{ url('Categoria/ACCESORIOS/CHARGER/CAR') }}"
                      class="block p-3 hover:bg-black opacity-30 text-black hover:text-white tracking-wide">CAR</a>
                  </li>
                  <li>
                    <a href="{{ url('Categoria/ACCESORIOS/CHARGER/WIRELESS') }}"
                      class="block p-3 hover:bg-black opacity-30 text-black hover:text-white tracking-wide">WIRELESS</a>
                  </li>
                  <li>
                    <a href="{{ url('Categoria/ACCESORIOS/CHARGER/WALL') }}"
                      class="block p-3 hover:bg-black opacity-30 text-black hover:text-white tracking-wide">WALL</a>
                  </li>
                </ul>
              </li>
              <li class="submenu grid grid-cols-5">
                <a href="{{ url('Categoria/ACCESORIOS/PEN') }}"
                  class="block-inline p-3 hover:bg-black opacity-30 text-black hover:text-white tracking-wide">PEN</a>
                <ul class="px-4 w-full   pb-6 pt-6 lg:pt-3">
                  <li>
                    <a href="{{ url('Categoria/ACCESORIOS/PEN/NOTE') }}"
                      class="block p-3 hover:bg-black opacity-30 text-black hover:text-white tracking-wide">NOTE</a>
                  </li>
                  <li>
              ...
              <li class="submenu grid grid-cols-5">
                <a href="{{ url('Categoria/ACCESORIOS/POWERBANK') }}"
                  class="block-inline p-3 hover:bg-black opacity-30 text-black hover:text-white tracking-wide">POWERBANK
                </a>
                <ul class="px-4 w-full   pb-6 pt-6 lg:pt-3">
                  <li>
                  ...
                  <li>
                    <a href="{{ url('Categoria/ACCESORIOS/POWERBANK/WIRED') }}"
                      class="block p-3 hover:bg-black opacity-30 text-black hover:text-white tracking-wide">WIRED</a>
                  </li>
                </ul>
              ...
              <li class="submenu grid grid-cols-5">
                <a href="{{ url('Categoria/ACCESORIOS/PROTECTION') }}"
                  class="block-inline p-3 hover:bg-black opacity-30 text-black hover:text-white tracking-wide">PROTECTION</a>
                <ul class="px-4 w-full   pb-6 pt-6 lg:pt-3">
                  <li>
                    <a href="{{ url('Categoria/ACCESORIOS/PROTECTION/GLASS COVER') }}"
                      class="block p-3 hover:bg-black opacity-30 text-black hover:text-white tracking-wide">GLASS
                      COVER</a>
                  </li>
                  <li>
                    <a href="{{ url('Categoria/ACCESORIOS/PROTECTION/SANITIZER') }}"
                      class="block p-3 hover:bg-black opacity-30 text-black hover:text-white tracking-wide">SANITIZER</a>
                  </li>
                </ul>
              </li>
              <li class="submenu grid grid-cols-5">
                <a href="{{ url('Categoria/ACCESORIOS/SELFIE STICK') }}"
                  class="block-inline p-3 hover:bg-black opacity-30 text-black hover:text-white tracking-wide">SELFIE
                  STICK</a>
                <ul class="px-4 w-full   pb-6 pt-6 lg:pt-3">
                  <li>
                    <a href="{{ url('Categoria/ACCESORIOS/SELFIE STICK/SELFIE STICK') }}"
                      class="block p-3 hover:bg-black opacity-30 text-black hover:text-white tracking-wide">SELFIE
                      STICK</a>
                  </li>
                </ul>
              </li>
              <li class="submenu grid grid-cols-5">
                <a href="{{ url('Categoria/ACCESORIOS/SOPORTE') }}"
                  class="block-inline p-3 hover:bg-black opacity-30 text-black hover:text-white tracking-wide">SOPORTE</a>
                <ul class="px-4 w-full   pb-6 pt-6 lg:pt-3">
                  <li>
                  ...
                  <li>
                    <a href="{{ url('Categoria/ACCESORIOS/SOPORTE/MOTORCYCLE') }}"
                      class="block p-3 hover:bg-black opacity-30 text-black hover:text-white tracking-wide">MOTORCYCLE</a>
                  </li>
                </ul>
              </li>
            </ul>
