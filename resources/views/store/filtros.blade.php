...
<div class="col">
    <div aria-label="breadcrumb">
        <ul class="breadcrumb align-right" style="background-color:grey ;margin-bottom:0px;padding: 20px; margin-top: 10px;">
            <li class="breadcrumb-item TrT0Xe col-md-offset-1"><a href="{{ url('/') }}">HOME</a></li>
            @foreach($dir as $d)
                                ...
                                <div class="col-12">
                                    <div class="col-3 col-lg-3 col-md-3">
                                        <div class="col-md-6 col-centered">
                                            <div class="container-fluid" >
                                                <button type="button" class="form-control" style="border: 0;font-weight: bold;" data-toggle="collapse"
                                                ...
                                                <div id="Resolucion" class="collapse" >
                                                    ...
                                                    <div class="form-group form-check">
                                                        ...
                                                        <label class="form-check-label" for="GalaxyTabS">Resolucion Full HD</label>
                                                    </div>
                                                    <div class="form-group form-check">
                                                        <input type="checkbox" class="form-check-input" id="GalaxyTabA">
                                                        <label class="form-check-label" for="GalaxyTabA">Resolucion 4k</label>
                                                    </div>
                                                    <div class="form-group form-check">
                                                        <input type="checkbox" class="form-check-input" id="GalaxyTabActive">
                                                        <label class="form-check-label" for="GalaxyTabActive">Resolucion 8k</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="container-fluid" >
                                                ...
                                                <div id="Tamaño" class="collapse" >
                                                    ...
                                                    <div class="form-group form-check">
                                                        ...
                                                        <label class="form-check-label" for="75+pulgadas">Mas de 75 Pulgadas</label>
                                                    </div>
                                                    <div class="form-group form-check">
                                                        <input type="checkbox" class="form-check-input" id="65+pulgadas">
                                                        <label class="form-check-label" for="65+pulgadas">65" - 74"</label>
                                                    </div>
                                                    <div class="form-group form-check">
                                                        <input type="checkbox" class="form-check-input" id="55+pulgadas">
                                                        <label class="form-check-label" for="55+pulgadas">55" - 64"</label>
                                                    </div>
                                                    <div class="form-group form-check">
                                                        <input type="checkbox" class="form-check-input" id="45+pulgadas">
                                                        <label class="form-check-label" for="45+pulgadas">45" - 54"</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="container-fluid" >
                                                ...
                                                <div id="Camara" class="collapse" >
                                                    ...
                                                    <div class="form-group form-check">
                                                        ...
                                                        <label class="form-check-label" for="24MP ~">24MP ~</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<div class="col-2 col-lg-2 col-md-2">
    <div class="row">
         @include('Components.producto-card', ['Productos' => $productos])
    </div>
</div>
